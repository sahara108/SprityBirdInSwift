...
#import "ShizzleTAGHelper.h"
#import "ShizzlePhoShizzleConstant.h"
#import "TAGManager.h"
#import "TAGContainerOpener.h"
#import "ShizzleUtils.h"
#import "ShizzleService.h"
#import "ShizzleTAGKeys.h"

@interface ShizzleTAGHelper ()
...
@implementation ShizzleTAGHelper

static dispatch_once_t onceToken;

static ShizzleTAGHelper *sharedInstance = nil;
...
{
    ShizzleService *service = [ShizzleService sharedInstance];
    [service logout];
    [[NSNotificationCenter defaultCenter] postNotificationName:ShizzleDidLogout object:nil];
    [self patchInfomationFromGTA];
}
...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change context:(void *)context
{
    if (context == TAGRefreshResourceFromNetworkContext) {
        ...
        if (![version isEqualToString:self.currentContainerVersion]) {
            ...
            [[[UIAlertView alloc] initWithTitle:@"" message:@"Google TAG manager has changed. Shizzle will automatically logout to apply new settings. Please sign in again to continue using." delegate:self cancelButtonTitle:DONE_BUTTON otherButtonTitles:nil] show];
        }
    }
}
